...
int main()
{
	...
	/* Time variables */
	ctypeRNum Thor = (typeRNum) 0.3;  /* Prediction horizon */
	...
	ctypeInt Nhor = 10;        /* Number of steps for the system integration */
	ctypeInt MaxMultIter = 3;  /* Maximum number of augmented Lagrangian iterations */
	...
	/********* userparam *********/
	typeRNum pCost[9] = { 100, 10, 180, 100, 10, -0.2, 0.2, -0.1, 0.1 };
