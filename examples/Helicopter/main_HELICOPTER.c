...
int main()
{
	...
	/* Time variables */
	ctypeRNum Thor = (typeRNum) 3.0;  /* Prediction horizon */
	...
	/********* userparam *********/
	typeRNum pCost[16] = { 0.44, 0.6, 100, 100, 10, 10, 400, 200, 0.001, 0.001, 100, 100, 10, 10, 400, 200 };
	...
	if (CPUtimeVec == NULL) {
		printError("Allocating memory for computation time measurement failed");
	}
