...
% This function runs the Helicopter example. It compiles the c-Code,
...
while 1
    ...
    % simulate system by evaluating discrete-time dynamics
    vec.x(:,i+1) = CmexFiles.grampc_ffct_Cmex(vec.t(i), vec.x(:,i), vec.u(:,i), vec.p(:,i), grampc.param, grampc.userparam);
