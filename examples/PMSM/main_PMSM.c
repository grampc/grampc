...
int main()
{
	...
	ctypeRNum xdes[NX] = { 0.0, 9.5, 0.0, 0.0 };

	/* Initial values, setpoints and limits of the inputs */
	ctypeRNum u0[NU] = { 0.0, 0.0 };
	ctypeRNum udes[NU] = { 0.0, 0.0 };
	ctypeRNum umax[NU] = { (typeRNum)323.3162, (typeRNum)323.3162 };
	ctypeRNum umin[NU] = { (typeRNum)-323.3162, (typeRNum)-323.3162 };

	/* Time variables */
	ctypeRNum Thor = (typeRNum) 0.005;  /* Prediction horizon */

	ctypeRNum dt = (typeRNum)0.000125;  /* Sampling time */
