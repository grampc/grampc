...
int main()
{
  ...
  typeRNum x0[NX]   = {100.0/9.81,0.0,200.0/9.81,0.0,0.0,0.0};
  typeRNum u0[NU]   = {1.0,0.0};
  typeRNum xdes[NX] = {0.0,0.0,100.0/9.81,0.0,0.0,0.0};
  typeRNum udes[NU] = {1.0,0.0};

  typeRNum umax[NU] = {3.0,6.0};
  typeRNum umin[NU] = {-3.0,-6.0};

  typeRNum uScale[NU]  = {3.0,6.0};
  typeRNum uOffset[NU] = {3.0,0.0};
