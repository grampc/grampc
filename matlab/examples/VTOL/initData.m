...
grampc_setopt_Cmex(grampc,'LineSearchMax',1e-2);
grampc_setopt_Cmex(grampc,'LineSearchMin',1e-3);
grampc_setopt_Cmex(grampc,'LineSearchInit',1e-2);
% grampc_setopt_Cmex(grampc,'LineSearchIntervalFactor',0.5);
% grampc_setopt_Cmex(grampc,'LineSearchAdaptFactor',2);
...
%% Parameter
% mandatory paramter 
x0     = [100.0/9.81,0.0,200.0/9.81,0.0,0.0,0.0];
u0     = [1.0,0.0];
xdes   = [0.0,0.0,100.0/9.81,0.0,0.0,0.0];
udes   = [1.0,0.0];
Thor   = 2.5;
dt     = 0.002;
% optional parameter
