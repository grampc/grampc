...
PYBIND11_MODULE(_core, m)
{
    ...
    pybind11::class_<ProblemDescription, PyProblem, ProblemDescriptionPtr>(m, "ProblemDescription")
        ...
        .def_readonly("Nx", &ProblemDescription::Nx)
        .def_readonly("Nu", &ProblemDescription::Nu)
        .def_readonly("Np", &ProblemDescription::Np)
        .def_readonly("Ng", &ProblemDescription::Ng)
        .def_readonly("Nh", &ProblemDescription::Nh)
        .def_readonly("NgT", &ProblemDescription::NgT)
        .def_readonly("NhT", &ProblemDescription::NhT)
